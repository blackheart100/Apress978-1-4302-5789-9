...
namespace EDMFundamentals
{
    ...
    {
        public static void InsertingAndRetrieving()
        {
            using (var context = new EF6RecipesContext())
            {
                ...
                context.People.Add(person); person = new Person { FirstName = "Billy", MiddleName = "Albert", LastName = "Minor", PhoneNumber = "907-2212" };
                context.People.Add(person); person = new Person { FirstName = "Kathy", MiddleName = "Anne", LastName = "Ryan", PhoneNumber = "722-0038" };
                context.People.Add(person);
